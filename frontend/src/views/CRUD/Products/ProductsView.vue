...
import TableSampleProducts from '@/components/Products/TableSampleProducts.vue'
...
const deleteFilter = (index) => {
  ...
  generateQuery();
  productsStore.fetch(null, query.value);
}
...
<template>
  ...
  <SectionHeroBar>Products</SectionHeroBar>
  <SectionMain>
    <BaseButtons>
      <BaseButton
        color="default"
  ...
  <SectionMain>
  <a class="text-blue-500 hover:text-blue-600 active:text-blue-700 mb-3 block" :href="externalLink">API documentation for products</a>
    ...
    <CardBox
      ...
      has-table
    >
      <TableSampleProducts checkable :sortTitle="sortTitle" :sortDirection="sortDirection" @sort="sortTable($event)" />
    </CardBox>
