...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'orderDate' && props.sortDirection]"
        @click="sort('orderDate')"
      >Order Date</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'product' && props.sortDirection]"
        @click="sort('product')"
      >Product</th>
      ...
      >
        ...
        />
              ...
              <td data-label="orderDate">
                {{ dataFormatter.dateTimeFormatter(client.orderDate) }}
              </td>    

              <td data-label="product">
                {{ dataFormatter.productsOneListFormatter(client.product) }}
              </td>
